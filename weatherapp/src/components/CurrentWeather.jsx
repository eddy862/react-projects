...
function CurrentWeather() {
  const { unit, selectedCity, currentWeather } = useContext(Context);

  return (
    <div
      className="mx-auto mt-6 shadow-lg rounded-lg bg-white md:w-9/12 lg:w-8/12 xl:w-7/12 2xl:w-6/12"
    >
      <div className="flex justify-between items-center px-4 py-3">
        <div className="text-xl font-semibold">
          {selectedCity.name}, {selectedCity.region}, {selectedCity.country}
        </div>
        <div>As of {currentWeather.last_updated}</div>
      </div>
      <hr />
      <div className="flex justify-between items-center px-8 py-5">
        ...
        <div>
          <img className="w-20" src={currentWeather.condition.icon} alt="" />
        </div>
      </div>
      <div className="flex flex-col px-8 py-2 text-lg divide-y-2">
        <div className="flex justify-between py-2">
          ...
          <div className="inline-flex items-center gap-1">
            <svg
              style={{ rotate: `${180 + currentWeather.wind_degree}deg` }}
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
              fill="currentColor"
        ...
        <div className="flex justify-between py-3">
          ...
          <div>
            {unit === "°C"
              ? `${currentWeather.dewpoint_c}`
              : `${currentWeather.dewpoint_f}`}
            °
          </div>
        </div>
        <div className="flex justify-between py-2">
          ...
          <div>{currentWeather.uv} of 11</div>
        </div>
        <div className="flex justify-between py-2">
          <div className="inline-flex items-center gap-3">
            <svg
          ...
          <div>
            {unit === "°C"
              ...
              : `${currentWeather.vis_miles} miles`}
          </div>
        </div>
        <div className="flex justify-between py-2">
          <div className="inline-flex items-center gap-3">
